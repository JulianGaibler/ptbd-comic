 ...
 * @param allThumbnails - An object containing metadata for all available thumbnails.
...
/**
 * Finds the panels for a given comic in the file system and matches them to the allPanels array to get the correct path.
 ...
 * The excerpt is generated by looking for the first non-empty line and taking the first sentence
 * (sentences end with any repetition of .!? followed by a space). If the first sentence is longer
 * than 200 characters, it is truncated.
